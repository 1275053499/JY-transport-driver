...
- (UIImageView *)scanningImageView {
    if (!_scanningImageView) {
        _scanningImageView = [[UIImageView alloc] initWithFrame:CGRectMake(75, 65, CGRectGetWidth(self.bounds) - 150, 3)];
...
- (UILabel *)QRCodeTipLabel {
    if (!_QRCodeTipLabel) {
        _QRCodeTipLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.clearRect) + 30, CGRectGetWidth(self.bounds) - 20, 15)];
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.clearRect = CGRectMake(kXHQRCodeRectPaddingX, 105, CGRectGetWidth(frame) - kXHQRCodeRectPaddingX * 2, CGRectGetWidth(frame) - kXHQRCodeRectPaddingX * 2);
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.scanningStyle) {
        case XHScanningStyleQRCode: {
            ...
            clearRect = CGRectMake(paddingX, 65, CGRectGetWidth(rect) - paddingX * 2, CGRectGetWidth(rect) - paddingX * 2);
            break;
        }
    ...
    UIImageView * topLeftView = [[UIImageView alloc]initWithFrame:CGRectMake(clearRect.origin.x, clearRect.origin.y, 15, 15)];
