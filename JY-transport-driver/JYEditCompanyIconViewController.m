...
//    
    ...
    NSString *key = [NSString stringWithFormat:@"LogisticsIcon%@%@.png",_companyModel.phone,keyStr];
    ...
    [upManager putData:data key:key token:token complete:^(QNResponseInfo *info, NSString *key, NSDictionary *resp) {
        ...
        _companyModel.icon = key;
        [JYAccountTool saveLogisticsModelInfo:_companyModel];
        //把七牛云的图片名称 上传到服务器
        [manager requsetDataUrl:@"app/logisticsgroup/updateLogisticsGroup" Id:_companyModel.id icon:key];
